...
base = pathlib.Path(r"g:\B2B steuer Business Ideee 6.8.2026\webseitenversionen\4.9.2026")

# 1. Update .figma/make/site.json to allow indexing!
site_json_path = base / ".figma" / "make" / "site.json"
if site_json_path.exists():
    site_cfg = {
        "title": "Kontenlage.de | Unabhängige Finanzbildung, Steuerrechner & Holding-Strukturierung",
        "description": "BaFin- und WpHG-konforme Steuerrechner (Rürup, Sparerpauschbetrag, VV-GmbH, Fünftelregelung) und legale Vermögensstrukturierung für Einkommen ab 60.000 €.",
        "language": "de",
        "robots": {
            "index": True
        },
    ...
    site_json_path.write_text(json.dumps(site_cfg, indent=2, ensure_ascii=False), encoding="utf-8")
    print("Updated site.json for Google SEO indexing!")

# 2. Enrich index.html with Schema.org JSON-LD & high-converting Meta
...
<html lang="de">
  <head>
    ...
    <title>Kontenlage.de | Unabhängige Finanzbildung, Steuerrechner &amp; Holding-Strukturierung</title>
    <meta name="description" content="BaFin- und WpHG-konforme Steuerrechner (Rürup, Sparerpauschbetrag, VV-GmbH, Fünftelregelung) und legale Vermögensstrukturierung ohne Provisionsvertrieb." />
    <meta name="robots" content="index, follow" />
    <link rel="canonical" href="https://kontenlage.de/" />

    <!-- OpenGraph / Social Meta -->
    <meta property="og:type" content="website" />
    <meta property="og:url" content="https://kontenlage.de/" />
    <meta property="og:title" content="Kontenlage.de — Unabhängige Finanzbildung &amp; Steueroptimierung" />
    <meta property="og:description" content="Objektive Rechner nach EStG, KStG und GewStG. Keine Vermittlungsprovisionen. 100% faktenbasiert." />
    <meta property="og:image" content="https://kontenlage.de/assets/og-kontenlage.png" />
    ...
    <script type="application/ld+json">
    {
      ...
      "name": "Kontenlage",
      "url": "https://kontenlage.de",
      "logo": "https://kontenlage.de/assets/logo.png",
      "description": "Unabhängige Plattform für Finanzbildung, mathematische Steuerrechner und Vermögensstrukturierung.",
      "sameAs": [
        "https://www.linkedin.com/company/kontenlage"
      ],
      "knowsAbout": [
        "Rürup-Rente § 10 EStG",
        "Sparerpauschbetrag § 20 EStG",
...
print("index.html enriched with Schema.org & OpenGraph!")

# 3. Enhance Abo.tsx with real Stripe Checkout integration
abo_path = base / "src" / "pages" / "Abo.tsx"
abo_content = r"""import { useState } from "react";
...
"""
abo_path.write_text(abo_content, encoding="utf-8")
print("Abo.tsx updated with Stripe checkout integration!")
