...
# Kontenlage Content Drafter v5

## 0. Content Contract

Jeder Text muss wissen:
- welche Fakten verwendet wurden
- welche Scores verwendet wurden
- welcher Datenstand gilt
- welche Methodikversion gilt
- welche Jurisdiktion gilt
- ob es Modellannahmen gibt.
...
Wenn Forecast vorhanden:
- Kennzeichnung als Prognose
- Annahmen
- Datenstand
- Unsicherheiten
- keine Garantie
...
Bei aktuellen oder rechtlich relevanten Behauptungen:
- Inline-/UI-Quelle
- Datum/Stichtag
- Jurisdiktion
- Scope
...
Der Drafter darf keine Compliance-Freigabe selbst erteilen.
